          ...
          <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <div className="mt-10  flex flex-col items-center justify-between space-y-4 botder-t border-b py-4 sm:flex-row sm:space-y-0">
              <div className="flex items-end">
                <h1
                  className={`text-3xl 0 font-bold mr-2 ${
            ...
            <ul className="mt-8 space-y-2">
              <li className="flex items-center text-left text-sm font-medium text-cyan-900">
            ...
            <div className="lg:col-span-3">
              <div className="border-b border-cyan-900">
                <nav className="flex gap-4">
                  <a
                    href="#"
                    className="border-b-2 border-cyan-900 py-4 text-sm font-medium text-cyan-900"
                  >
                    Description
                  </a>
                </nav>
              </div>
              <div className="mt-8 text-cyan-900 flow-root sm:mt-12">
