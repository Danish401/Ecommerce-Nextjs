            ...
            <div className="px-4 py-6 sm:px-8 sm:py-10">
              ...
              <div className="mt-6 border-t border-b py-2">
                <div className="flex items-center justify-between">
                  <p className="text-sm text-cyan-900">Subtotal</p>
                ...
                <div className="flex items-center justify-between">
                  <p className="text-sm text-cyan-900">Shipping</p>
                  <p className="text-lg text-black font-semibold">free</p>
                </div>
                <div className="flex items-center justify-between">
                  <p className="text-sm text-cyan-900">Total</p>
                  <p className="text-lg text-black font-semibold">
                    &#8377;
                    {cartItems && cartItems.length
                      ? cartItems.reduce(
